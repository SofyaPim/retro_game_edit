...
class Game {
  ...
  drawStatusText(context) {
    ...
    for (let i = 0; i < this.player.maxLives; i++) {
      context.strokeRect(20 + 20 * i, 80, 10, 10);
    }
    for (let i = 0; i < this.player.lives; i++) {
      context.fillRect(20 + 20 * i, 80, 10, 10);
    }
    if (this.gameOver) {
      context.save();
      context.textAlign = "center";
      ...
      context.fillText("Press R to restart", this.width * 0.5, this.height * 0.7);
      context.restore();
    }
  }
  newWave() {
